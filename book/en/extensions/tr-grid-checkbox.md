...
Aside from clicking top checkbox or group checkbox, you can do `Shift+Click` to selecting all checkboxes in a range from an anchor checkbox to the clicked checkbox.
